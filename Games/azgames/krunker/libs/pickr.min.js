	...
	return (() => {
		var t = {
				...
				8457: (t, e, r) => {
					...
					t.exports = function (t) {
						...
						if ((b && (y = n(y, g > 2 ? arguments[2] : void 0, 2)), null == m || (d == Array && a(m))))
							for (r = new d((e = c(h.length))); e > x; x++) (v = b ? y(h[x], x) : h[x]), s(r, x, v);
						else
							for (f = (p = m.call(h)).next, r = new d(); !(l = f.call(p)).done; x++)
					...
					t.exports = function (t, e, r, l, v, w, S) {
						...
						if (
							(T &&
								...
								h !== Object.prototype &&
									O.next &&
									(p || i(O) === h || (a ? a(O, h) : 'function' != typeof O[g] && s(O, g, x)),
									c(O, E, !0, !0),
									p && (f[E] = x))),
							v == b &&
								C &&
							...
							if (((_ = { values: j(b), keys: w ? I : j(y), entries: j(m) }), S))
						...
						o(function () {
							...
							? function (t, e) {
									for (var r = s(t), o = arguments.length, l = 1, p = a.f, f = c.f; o > l; )
										for (var v, h = u(arguments[l++]), d = p ? i(h).concat(p(h)) : i(h), g = d.length, y = 0; g > y; )
					...
					(c[p] = !0),
						(t.exports =
							...
							function (t, e) {
								var r;
								return (
									null !== t ? ((f.prototype = o(t)), (r = new f()), (f.prototype = null), (r[p] = t)) : (r = h()),
									void 0 === e ? r : i(r, e)
								);
							});
				},
				...
				1320: (t, e, r) => {
					...
					(t.exports = function (t, e, r, c) {
						...
						'function' == typeof r &&
							...
							(s = l(r)).source || (s.source = p.join('string' == typeof e ? e : ''))),
							t !== n
								? (u ? !v && t[e] && (f = !0) : delete t[e], f ? (t[e] = r) : o(t, e, r))
								: f
									? (t[e] = r)
									: a(e, r);
							...
							if (
								...
								w
									? o
										...
										: (p.lastIndex = 0)
									: d && o && (p.lastIndex = p.global ? o.index + o[0].length : n),
								y &&
									o &&
									o.length > 1 &&
						...
						c = function (t) {
							return function (e, r, c) {
								...
								return v <= p || '' == f
									? l
									: ((s = v - p),
										(u = o.call(f, a(s / f.length))).length > s && (u = u.slice(0, s)),
										t ? l + u : u + l);
							};
						};
				...
				5112: (t, e, r) => {
					...
					t.exports = function (t) {
						return (
							(i(u, t) && (c || 'string' == typeof u[t])) || (c && i(l, t) ? (u[t] = l[t]) : (u[t] = p('Symbol.' + t))),
							u[t]
						);
					};
				},
						...
						{ target: 'Array', proto: !0, forced: !l },
						{
							splice: function (t, e) {
								var r,
									...
									w = arguments.length;
								if (
									(0 === w ? (r = n = 0) : 1 === w ? ((r = 0), (n = m - x)) : ((r = w - 2), (n = f(p(i(e), 0), m - x))),
									m + r - n > v)
								)
									throw TypeError(h);
								...
								if (((l.length = n), r < n)) {
									...
									for (d = m - n; d > x; d--) (y = d + r - 1), (g = d + n - 1) in b ? (b[y] = b[g]) : delete b[y];
						...
						},
						{
							toFixed: function (t) {
								...
								return (g =
									u > 0
										? d +
											((c = g.length) <= u ? '0.' + a.call('0', u - c) + g : g.slice(0, c - u) + '.' + g.slice(c - u))
										: d + g);
							},
						},
					);
					...
					n(
						{ target: 'Object', stat: !0, sham: !o },
						{
							getOwnPropertyDescriptors: function (t) {
								for (var e, r, n = a(t), o = c.f, u = i(n), l = {}, p = 0; u.length > p; )
							...
							return [
								...
								function (t, o) {
									...
									for (var w, S = '', O = 0, _ = 0; _ < m.length; _++) {
										x = m[_];
										for (var A = String(x[0]), j = v(h(c(x.index), d.length), 0), E = [], P = 1; P < x.length; P++)
										...
										? function (t, r) {
												...
												for (
													...
													!(
														...
														c.length > 1 && c.index < n.length && d.apply(l, c.slice(1)),
														(u = c[0].length),
														(v = s),
														l.length >= i)
													);
												...
												return (
													v === n.length ? (!u && h.test('')) || l.push('') : l.push(n.slice(v)),
								...
								[
									...
									function (t, o) {
										...
										var p = i(this),
											...
											d = p.unicode,
											b =
												(p.ignoreCase ? 'i' : '') + (p.multiline ? 'm' : '') + (p.unicode ? 'u' : '') + (h ? 'g' : 'y'),
					...
					var n = r(2109),
						...
						ct = function (t, e, r) {
							...
							return (
								...
								p(J, n)
									? (r.enumerable
											? (p(t, B) && t[B][n] && (t[B][n] = !1), (r = m(r, { enumerable: b(0, !1) })))
						...
						ut = function (t) {
							...
							return (
								!(this === G && p(J, e) && !p(Q, e)) &&
								(!(r || !p(this, e) || !p(J, e) || (p(this, B) && this[B][e])) || r)
							);
						},
						lt = function (t, e) {
							var r = g(t),
		...
		return (
			(() => {
				...
				function O(t, e, r) {
					...
					return (
						0 !== n && (e = 1 === n ? 0 : n < 0.5 ? (e * r) / (2 * n) : (e * r) / (2 - 2 * n)), [t, 100 * e, 100 * n]
					);
				}
				function _(t, e, r) {
					var n,
					...
					if (0 === c) n = o = 0;
						...
						var s = ((a - t) / 6 + c / 2) / c,
							u = ((a - e) / 6 + c / 2) / c,
							l = ((a - r) / 6 + c / 2) / c;
						t === a ? (n = l - u) : e === a ? (n = 1 / 3 + s - l) : r === a && (n = 2 / 3 + u - s),
							n < 0 ? (n += 1) : n > 1 && (n -= 1);
					}
							...
							if (!(C < $[0] || C + N[0] > B[0]))
								for (var V, G = R(S); !(V = G()).done; ) {
									var W = V.value,
										z = g[(k ? 'v' : 'h') + W];
									if (!(z < U || z + D > H))
										return (e.style[L] = z - h[L] + 'px'), (e.style[T] = C - h[T] + 'px'), P + W;
								}
						}
				...
				var G = (function () {
						...
						this._setupAnimationFrame = requestAnimationFrame(function e() {
							...
							y.setColor(t.default),
								...
								t.defaultRepresentation &&
									((y._representation = t.defaultRepresentation), y.setColorRepresentation(y._representation)),
								t.showAlways && y.show(),
					...
					return (
										...
										onchange: function (t, n) {
											if (r.palette) {
												var o = c(),
													...
													l = s.currentColor;
												e._recalc &&
													((o.s = 100 * t), (o.v = 100 - 100 * n), o.v < 0 && (o.v = 0), e._updateOutput('slider'));
												...
												(this.element.style.background = p),
													(this.wrapper.style.background =
														...
														'))\n                    '),
													a.comparison
														? a.useAsButton || e._lastColor || u.style.setProperty('--pcr-color', p)
														: (i.button.style.setProperty('--pcr-color', p), i.button.classList.remove('clear'));
						...
						(r._rePositioningPicker = function () {
							...
							if (
								!t.inline &&
								!this._nanopop.update({ container: document.body.getBoundingClientRect(), position: t.position })
							) {
						...
						(r.setHSVA = function () {
							var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 360,
								...
								i = this._recalc;
							if (((this._recalc = !1), t < 0 || t > 360 || e < 0 || e > 100 || r < 0 || r > 100 || n < 0 || n > 1))
								return !1;
