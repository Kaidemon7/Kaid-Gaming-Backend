                ...
                return o(t, e), n = t, t.prototype.onLoad = function() {
                    ...
                    try {
                        if (o.getComponent("fruitData").fruitNumber == 10) {
                            ...
                            const hostUrl = location.hostname === "localhost" || location.hostname === "127.0.0.1" ? 'http://localhost:8000' : "https://1oar.com/admin.php/suika.con/get_scores"
                            const data = { ip: ip, suikaTime: milliseconds, score: null }
                            axios.post(hostUrl + '', data)
                            .then(response => {
                            });
                        }
                    } catch(e) {
