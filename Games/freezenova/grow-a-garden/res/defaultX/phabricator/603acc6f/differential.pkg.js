...
label=JX.DOM.find(this._row,'label','differential-inline-done-label');JX.DOM.alterClass(label,'loading',true);var
...
label=JX.DOM.find(this._row,'label','differential-inline-done-label');JX.DOM.alterClass(label,'loading',false);var
