...
<script nonce="MY2Oam6VqoesVh0LF9MJjiLVjNxMLnzERFcuAKlUp5TZygq2" src="/static/v20260908.1/js/jquery/jquery-min.js"></script><script nonce="MY2Oam6VqoesVh0LF9MJjiLVjNxMLnzERFcuAKlUp5TZygq2" src="/static/v20260908.1/js/jquery/ui/jquery-ui-min.js"></script><script nonce="MY2Oam6VqoesVh0LF9MJjiLVjNxMLnzERFcuAKlUp5TZygq2" src="/static/v20260908.1/js/jquery/plugins/devbridgeAutocomplete/devbridgeAutocomplete-min.js"></script><script nonce="MY2Oam6VqoesVh0LF9MJjiLVjNxMLnzERFcuAKlUp5TZygq2" src="/static/v20260908.1/js/global.js"></script><script nonce="MY2Oam6VqoesVh0LF9MJjiLVjNxMLnzERFcuAKlUp5TZygq2" src="/static/v20260908.1/js/util.js"></script><script nonce="MY2Oam6VqoesVh0LF9MJjiLVjNxMLnzERFcuAKlUp5TZygq2" src="/static/v20260908.1/js/widgets.js"></script>

      <script nonce="MY2Oam6VqoesVh0LF9MJjiLVjNxMLnzERFcuAKlUp5TZygq2">BUGZILLA.value_descs = JSON.parse('{\"bug_status\":{},\"resolution\":{\"\":\"---\"}}');

      </script>
<script nonce="MY2Oam6VqoesVh0LF9MJjiLVjNxMLnzERFcuAKlUp5TZygq2" src="/static/v20260908.1/js/lib/prism.js"></script><script nonce="MY2Oam6VqoesVh0LF9MJjiLVjNxMLnzERFcuAKlUp5TZygq2" src="/static/v20260908.1/js/consent.js"></script><script nonce="MY2Oam6VqoesVh0LF9MJjiLVjNxMLnzERFcuAKlUp5TZygq2" src="/static/v20260908.1/js/cookie-helper.js"></script><script nonce="MY2Oam6VqoesVh0LF9MJjiLVjNxMLnzERFcuAKlUp5TZygq2" src="/static/v20260908.1/js/lib/md5.min.js"></script><script nonce="MY2Oam6VqoesVh0LF9MJjiLVjNxMLnzERFcuAKlUp5TZygq2" src="/static/v20260908.1/extensions/Review/web/js/badge.js"></script>
...
<form method="post" action="/github.cgi">
    <input type="hidden" name="github_token" value="">
    <input type="hidden" name="target_uri" value="https://bugzilla.mozilla.org/showdependencytree.cgi">
    <button type="submit">
  ...
  <form action="/showdependencytree.cgi?id=1670675&amp;amp%3Bhide_resolved=1" method="POST"
        data-qs-suffix="_top">
    ...
    <input type="hidden" name="Bugzilla_login_token"
           value="1789095003-iJq1CkE5rUAjgA3WUghGWzThiIY6olosuDQXfa6xk_0">
  ...
  <form action="/token.cgi" method="post">
    ...
    <input type="hidden" id="token_top" name="token" value="1789095003-1UtHbQFbRaq4KqgdOFRNbdDPowLCU87L3aJgzczsaUE">
...
<form method="post" action="/github.cgi">
  ...
  <form name="login" action="/showdependencytree.cgi" method="POST">
...
<input type="hidden" name="id"
      ...
      <input type="hidden" name="amp;hide_resolved"
             value="1">
    ...
    <section>
      ...
      <form id="forgot" method="get" action="/token.cgi">
        ...
        <input type="hidden" id="token" name="token"
               value="1789095003-1UtHbQFbRaq4KqgdOFRNbdDPowLCU87L3aJgzczsaUE">
        <p>
