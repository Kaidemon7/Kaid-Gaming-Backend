...
<form method="post" action="/github.cgi">
    <input type="hidden" name="github_token" value="">
  ...
  <form action="/enter_bug.cgi?product=Core&amp;amp%3Bcomponent=DOM%3A%20Networking" method="POST"
    ...
    <input type="hidden" name="Bugzilla_login_token"
           value="1789094985-TNOakIMgQ0TWcIhDJPYnJL6I8u6Q_WxmBbZF-WhOJOw">
  ...
  <form action="/token.cgi" method="post">
    ...
    <input type="hidden" id="token_top" name="token" value="1789094985-42jM7j34L1kvk8iQ_s-C7nXukaTpOgGzup0ZD6hlqT0">
    ...
    <section>
      ...
      <form id="forgot" method="get" action="/token.cgi">
        ...
        <input type="hidden" id="token" name="token"
               value="1789094985-42jM7j34L1kvk8iQ_s-C7nXukaTpOgGzup0ZD6hlqT0">
        <p>
