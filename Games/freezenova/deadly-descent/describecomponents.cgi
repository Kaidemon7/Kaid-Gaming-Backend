...
<form method="post" action="/github.cgi">
    <input type="hidden" name="github_token" value="">
  ...
  <form action="/describecomponents.cgi?product=Firefox" method="POST"
    ...
    <input type="hidden" name="Bugzilla_login_token"
           value="1789095013-seiMjBT1z-qFKau09XKJuuxKllRg-PZbLJvkBKe6jT8">
  ...
  <form action="/token.cgi" method="post">
    ...
    <input type="hidden" id="token_top" name="token" value="1789095013-_BLtWvQWlD_cjzRnyBWd_ZwzVTuVk9gf4MS4_D3gfeg">
