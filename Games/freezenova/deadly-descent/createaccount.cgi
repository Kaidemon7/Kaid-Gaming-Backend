...
<form method="post" action="/github.cgi">
    <input type="hidden" name="github_token" value="">
  ...
  <form action="/createaccount.cgi" method="POST"
    ...
    <input type="hidden" name="Bugzilla_login_token"
           value="1789094931-wBMmLQvgDqbVqNJtKv3zUHDPRer2jEBnWTQeRXOQT3s">
  ...
  <form action="/token.cgi" method="post">
    ...
    <input type="hidden" id="token_top" name="token" value="1789094931-JpDoQOJr3K12kWy22wlKDHC0QTnCBbzqnb1p5ce3y-A">
...
<li>
  ...
  <form method="post" action="/createaccount.cgi" onsubmit="return onSubmit()">
    ...
    <tr>
    <td colspan="2">
      <input type="hidden" id="token" name="token" value="1789094931-uTLqQLrKYwjQBzKC_DVQ9pSU6LBNS185-9BpCH4f37w">
